...
var SITE_LOGO     = 'https://linetogel73.com/assets/img/ei/logo.png';
...
var BG_IMAGE      = 'https://cdn.areabermain.club/assets/cdn/az6/2026/01/08/20260108/0e9b0ec9a88ad88a5935bc5802bc41a5/linetogel-background-07januari2026.jpg';
var BG_OVERLAY    = 'rgba(19,0,32,0.55), rgba(28,0,48,0.62)';
...
function showLoading(msg, sub){
  root.innerHTML =
    ...
    '<img src="https://linetogel73.com/assets/img/ei/logo.png" alt="LINE TOGEL" style="width:110px;max-height:72px;object-fit:contain;filter:drop-shadow(0 0 16px #CE4FFF);margin-bottom:8px;"/>'+
...
async function fetchHTML(url){
  for(var i=0;i<PROXIES.length;i++){
    var px=PROXIES[i];
    try{
      showLoading('Memuat Prediksi LINE TOGEL…','['+( i+1)+'/'+PROXIES.length+'] Mencoba '+px.name+'…');
...
async function loadAndRender(){
  try {
    showLoading('Memuat Prediksi LINE TOGEL…','Mengambil data dari sumber…');
    var html = await fetchHTML(SOURCE_URL);
    showLoading('Memuat Prediksi LINE TOGEL…','Memproses data prediksi…');
    ...
    showLoading('Memuat Prediksi LINE TOGEL…','Membangun tampilan…');
